  ...
  return (
    <div className="fade-in shell">
      <div className="py-6 font-mono text-[10.5px] text-ink-3 uppercase tracking-[0.14em]">
        <Link className="text-inherit" href={localeHref(locale, "/")}>
          {p.breadcrumbAtelier}
        </Link>
        <span className="mx-[10px]">/</span>
        <Link className="text-inherit" href={localeHref(locale, "/collection")}>
        ...
        <div>
          ...
          <div className="actions">
            ...
            <Link
              ...
              href={localeHref(locale, `/request?ref=${product.id}`)}
            >
              {t.cta.requestPiece}
            </Link>
          </div>
